...
%  xnode=xNode,ynode=yNode  %%%****输出当前节点，用来学习了解A*算法的运算过程****  ///不需要知道过程可注释掉///
 exp_array=expand_array06(xNode,yNode,path_cost,xTarget,yTarget,CLOSED,MAX_X,MAX_Y,Nobs,xStart,yStart);  %%% 不在关闭列表的子节点，（x,y,gn,hn,fn）,列数是个数
