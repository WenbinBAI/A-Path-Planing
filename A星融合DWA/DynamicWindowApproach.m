function [u,trajDB,xt_yu]=DynamicWindowApproach(x,model,goal,evalParam,ob,R,Obs_dong,R_dong_obs)
...
% 评价函数的计算
[evalDB,trajDB,xt_all]=Evaluation_du2(x,Vr,goal,ob,R,model,evalParam,Obs_dong,R_dong_obs);
